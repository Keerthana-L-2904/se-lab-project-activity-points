...
public class StudentController {
    ...
    public ResponseEntity<Object> getStudent(@PathVariable String studentID) {
        return studentService.getStudentWithFA(studentID)
                .<ResponseEntity<Object>>map(studentDto -> ResponseEntity.ok().body(studentDto))
    ...
    public StudentActivity getLatestActivity(@PathVariable String studentID) {
        return studentService.getLatestActivity(studentID);
    }
    ...
    public List<StudentWithMandatoryDTO> getStudentsByFAIDWithMandatory(@PathVariable int FAID) {
